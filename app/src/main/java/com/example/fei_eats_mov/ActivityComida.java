...
public class ActivityComida extends AppCompatActivity {
   ...
   // private SlideshowViewModel slideshowViewModel;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = findViewById(R.id.recyclerViewMensajes123);

        mRecyclerView.setLayoutManager(new LinearLayoutManager(ActivityComida.this));
        ...
        final Button btnRegresar = findViewById(R.id.btnRegresar123);

        btnRegresar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent registrar = new Intent(ActivityComida.this, ActivityDefault2.class);
