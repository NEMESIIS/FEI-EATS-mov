...
public class ActivityTodos extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = findViewById(R.id.recyclerViewMensajes66);

        mRecyclerView.setLayoutManager(new LinearLayoutManager(ActivityTodos.this));
        ...
        final Button btnRegresar = findViewById(R.id.btnRegresar66);

        btnRegresar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent registrar = new Intent(ActivityTodos.this, ActivityDefault2.class);
